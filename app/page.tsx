    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-purple-950 animate-gradient spotlight-effect">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-12 float-animation cursor-parallax cursor-parallax-slow">
              ...
              {tabs.map((tab, index) => (
                <button
                  ...
                  style={{ 
                    ...
                    animation: activeTab === tab.id ? 'pulse-slow 3s ease-in-out infinite' : 'none'
                  }}
                >
                  {/* Ripple effect overlay */}
                  <span className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-300 ripple-effect"></span>
        ...
        <footer className="border-t border-zinc-200 dark:border-zinc-800 mt-20 transition-all duration-300 hover:border-purple-400 cursor-glow">
